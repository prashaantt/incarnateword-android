...
// + "<style type='text/css'>img { max-width: 100%; width: auto; height: auto; }>"
                ...
                photoToLoad.imageView.setWebViewClient(new WebViewClient() {
                ...
                photoToLoad.imageView.setWebViewClient(new WebViewClient() {
                    ...
                    public void onPageFinished(WebView view, String url) {
                        try {
                            photoToLoad.imageView.clearCache(true);
                        }catch (Exception e){
                            e.printStackTrace();
                        }
                        // do your stuff here
